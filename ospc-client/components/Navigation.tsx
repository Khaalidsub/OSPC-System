...
export const Navigation = () => {
    return (
        <div className=" bg-blue-100 text-center p-3 md:w-16 lg:w-56 flex flex-row md:flex-col items-center justify-center md:justify-start sticky inset-x-0 bottom-0  md:inset-x-auto md:bottom-auto md:static">
