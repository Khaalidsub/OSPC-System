...
interface SubjectProps {
    subject: SubjectsTypes.getSubjects_subjects
}
function Subjects() {
    const [search, setSearch] = useState('')
    const { data, fetchMore } = useQuery<SubjectsTypes.getSubjects>(SUBJECTS)
    ...
    return (
        <div className="grid grid-cols-1">
            <div className="flex flex-col space-y-8 w-3/4 place-self-center">
                <h4 className="text-4xl">List of Subjects in CS</h4>
