...
export const AdminNavigation = () => {
    ...
    return (
        <div className="bg-primary    text-center p-3 md:w-16 lg:w-64 flex flex-row md:flex-col md:space-y-8 items-center justify-center md:justify-start sticky inset-x-0 bottom-0  md:inset-x-auto md:bottom-auto md:static">
            ...
            <ul className="hidden   md:flex flex-col justify-between text-base text-white h-full">
                <div className="md:space-y-16">
                    ...
                    <NavigationIcon href='/admin' onClick={handleClick} label="DashBoard" icon="/assets/dashboard.svg" />
                    ...
                    <NavigationIcon href='/admin/students' onClick={handleClick} label="students" icon="/assets/student.svg" />
                    <NavigationIcon href='/admin/coaches' onClick={handleClick} label="coaches" icon="/assets/coach.svg" />
                    <NavigationIcon href='/admin/moderators' onClick={handleClick} label="moderators" icon="/assets/user.svg" />
